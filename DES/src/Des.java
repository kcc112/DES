public class Des {
    ...
    private byte[] P = {16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5,
            18, 31, 10, 2, 8, 24, 14, 32, 27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25};

    private static byte[] lastIP = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47,
    ...
    private String chengeToString(String text){
        ...
        String outputText = "";
        int blockNumber = text.length() / 8;
        for(int i = 0; i < blockNumber; i++){
            String asciText = text.substring(i*8, i*8+8);
